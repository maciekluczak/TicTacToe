...
public class GameField3D extends JLabel implements MouseListener {
    ...
    public GameField3D(int fieldSize){
        gameBufor = new GameBufor();
        Font LABEL_FONT = new Font(Font.DIALOG, Font.PLAIN, fieldSize);
        cross= new ImageIcon("Icons\\cancel64.png");
        circle= new ImageIcon("Icons\\circumference (3).png");
        this.setText("     ");
