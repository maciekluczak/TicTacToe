...
public class PlayButton extends JLabel implements MouseListener {
    ...
    public PlayButton(int PlayButtonWidth, int PlayButtonHeight){
        ...
        ImageIcon image = new ImageIcon("Icons\\Play!32.png");
        ...
        imageLabelAnimated = new ImageIcon("Icons\\Play!50.png");
